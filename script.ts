  ...
  newl.innerHTML = `
    ...
    <div class="task-description">
      <ul>
        ...
        <li>Due Time: ${task.time}</li>
        <li>Partner: ${task.partner}</li>
        <li>Priority: ${priorityString}</li>
      </ul>
    </div>
  `;
...
sub.addEventListener('click', (e) => {
  ...
  if (editBool) {
    ...
    updateElement.innerHTML = `
      ...
      <div class="task-description">
        <ul>
          <li>Name: ${toUpdate.name}</li>
          <li>Description: ${toUpdate.desc}</li>
          <li>Due Date: ${toUpdate.date}</li>
          <li>Time: ${toUpdate.time}</li>
          <li>Partner: ${toUpdate.partner}</li>
          <li>Priority: ${priorityString}</li>
        </ul>
      </div>
    `;
